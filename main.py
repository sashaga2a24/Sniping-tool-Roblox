 ...
 class Sniper:
    ...
    def run_bot(self):
        ...
        async def stats(ctx):
            ...
            embed.set_author(name=f"Tacocatt Sniper {self.version}")
    ...
    def check_version(self):
        ...
        self.task = "Pastebin Checker"
        self._print_stats()
        response = requests.get("https://pastebin.com/raw/28KiVCrR")
                    ...
                    async with client.post(f"https://apis.roblox.com/marketplace-sales/v1/item/{item_id}/purchase-item",
                        ...
                        if not json_response["purchased"]:
                            ...
                            if self.webhookEnabled:
                                embed_data = {
                                    "title": "New Item Purchased with Tacocatt Sniper",
